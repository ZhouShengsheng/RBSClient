 ...
 *  Report every touch.
 */
@property (assign, nonatomic) BOOL shouldReportEveryTouch;
 ...
 *  Badge controllers.
 */
@property (strong, readonly, nonatomic) NSMutableArray<SSBadgeController *> *badgeControllers;

/**
 *  Update self and self.scrollView clipsToBounds properties.
 */
